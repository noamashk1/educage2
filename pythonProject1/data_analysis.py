...
class DataAnalysis:
    ...
    def open_graph_window(self):
        ...
        # register window for cleanup on main close
        ...
        def on_close():
            ...
            try:
                ...
                pass
            try:
                if new_window in self.graph_windows:
                    self.graph_windows.remove(new_window)
            except Exception:
                pass
            new_window.destroy()
            try:
    ...
    def _on_main_close(self):
        # Close any open graph windows and all Matplotlib figures, then destroy main window
        try:
            for w in list(self.graph_windows):
                try:
                    if w.winfo_exists():
                        w.destroy()
                except Exception:
